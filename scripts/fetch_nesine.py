"""
Nesine API - Gunluk Mac Cekilmesi
GitHub Actions her gun calistirir
"""
...
LEAGUE_MAP = {
    ...
    # Ek kodlar - Nesine LC degerleri
    100:"TR1", 101:"TR1", 102:"TR1", 103:"TR1", 104:"TR1",
    200:"TR1", 201:"TR1", 202:"TR1", 203:"TR1",
    300:"EN1", 301:"EN1", 400:"DE1", 500:"IT1", 600:"ES1",
    700:"FR1", 800:"PT1", 900:"NL1"
}

# Lig adi ile eslestir (LC bilinmiyorsa)
LEAGUE_NAME_MAP = {
    "super lig": "TR1", "turk": "TR1", "turkey": "TR1",
    "premier league": "EN1", "england": "EN1",
    "bundesliga": "DE1", "germany": "DE1",
    "serie a": "IT1", "italy": "IT1",
    "la liga": "ES1", "spain": "ES1",
    "ligue 1": "FR1", "france": "FR1",
    "eredivisie": "NL1", "portugal": "PT1",
    "greece": "GR1", "belgium": "BE1"
}
...
def main():
    ...
    print(f"Kaydedildi: {len(matches)} mac")
